...
* Bytes array are fan-ta-stic and very light in memory.
...
<Title level={3}>Let's build the most efficient LRU Cache!</Title>
...
<small>
  Bench <a href="https://github.com/dominictarr/bench-lru">here</a> - I masked libraries which are not "real" LRU.
</small>
...
```js
// Iterative version - more alien but faster
