...
describe('HashedArrayTree', function() {
  ...
  //   assert.throws(function() {
  //     new HashedArrayTree({blockSize: 27});
  //   }, /power of two/);
  // });
  ...
  //   var array = new HashedArrayTree(Uint32Array, 3);
  ...
  //   var array = new HashedArrayTree(Uint8Array, 10);
  ...
  //   var array = new HashedArrayTree(Uint8Array, {initialLength: 23});
  ...
  //   var array = new HashedArrayTree.DynamicFloat64Array({initialLength: 3});
